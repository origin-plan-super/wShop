...
<body>
        ...
        <div class="layui-form-item">
            <div class="layui-block">
                ...
                <div class="layui-input-inline" style="width: 500px;">
                    <input type="text" name="goods_title" placeholder="" value="<?php echo ($goods["goods_title"]); ?>" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        var headImgApp = new Vue({
            el: '#headImgApp',
            data: {
                img: '/wShop/' + '<?php echo ($goods["head_img"]); ?>',
                src: '<?php echo ($goods["head_img"]); ?>',
                remove: false,
                title: '上传图片'
            }
        });
        ...
        var infoHeadImgApp = new Vue({
            el: '#infoHeadImgApp',
            data: {
                img: '/wShop/' + '<?php echo ($goods["info_head_img"]); ?>',
                src: '<?php echo ($goods["info_head_img"]); ?>',
                remove: false,
                title: '上传图片'
            }
        });
        var colorApp = new Vue({
            el: '#colorApp',
            data: {
                items: JSON.parse('<?php echo ($goods["color"]); ?>'),
                msg: '',
                count: 0
            },
            methods: {
        ...
        var sizeApp = new Vue({
            el: '#sizeApp',
            data: {
                items: JSON.parse('<?php echo ($goods["size"]); ?>'),
                msg: ''
            },
            methods: {
                add: function () {
        ...
        var size2App = new Vue({
            el: '#size2App',
            data: {
                items: JSON.parse('<?php echo ($goods["size2"]); ?>'),
                msg: ''
        ...
        layui.use(['form', 'laydate', 'upload'], function () {
            ...
            (function () {
                ...
                var fun = function (res) {
                    ...
                    linkage(arr, form, '<?php echo ($goods["brand_id"]); ?>', '<?php echo ($goods["class_id_1"]); ?>', '<?php echo ($goods["class_id_2"]); ?>');
